...
(() => {
  ...
  window.__LOAD_PLAZA_EXTRAS__ = () => {
    ...
    return Promise.all([
      loadFeatureScript('/plaza-auto-masonry.js?v=84bfcf807e1a815e5c85d17bb8ad43111c0ee70d'),
      loadFeatureScript('/plaza-comment-mode.js?v=84bfcf807e1a815e5c85d17bb8ad43111c0ee70d')
    ])
      .then(() => {
