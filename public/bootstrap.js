...
(() => {
  ...
  const warmHomeAssets = () => {
    preloadCriticalAsset('/style.css?v=20260731-approved1', 'style', 'high');
    preloadCriticalAsset('/site-path.js?v=20260731-approved1', 'script', 'auto');
    preloadCriticalAsset('/app.js?v=20260731-approved1', 'script', 'auto');
  };
  ...
  window.__LOAD_PLAZA_EXTRAS__ = () => {
    ...
    return Promise.all([
      loadFeatureScript('/plaza-auto-masonry.js?v=20260731-approved1'),
      loadFeatureScript('/plaza-comment-mode.js?v=20260731-approved1')
    ])
      .then(() => {
  ...
  const bootstrap = async () => {
    ...
    try {
      ...
      loadStylesheet('/style.css?v=20260731-approved1');
      /* ROLE_SCOPED_ADMIN_STYLE_V1 */
      if (window.__BOOTSTRAP_USER__?.role === 'admin') {
        loadStylesheet('/admin-dashboard-refactor.css?v=20260731-approved1');
      }
      await loadScript('/site-path.js?v=20260731-approved1');
      await loadScript('/app.js?v=20260731-approved1');
